...
<head>
    ...
    <title>Bookings - Jambangan Cultural Dance</title>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-[#121212] p-8 rounded-lg shadow-xl">
                        ...
                        <div class="space-y-4 text-gray-300">
                            <p class="text-lg">For urgent inquiries or special requests, please contact us directly:</p>
                            <div class="space-y-2">
                                <p class="flex items-center gap-2">
                                    <svg class="w-6 h-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                    </svg>
                                    <span>jambangan@culture.ph</span>
                                </p>
                                <p class="flex items-center gap-2">
                                    <svg class="w-6 h-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
