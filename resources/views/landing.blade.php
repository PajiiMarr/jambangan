...
<body class="bg-[#0D0D0D] text-[#FFD700] font-monterchi">
    ...
    <!-- ✨ About Section -->
    <section id="aboutUs" class="py-12 px-6 bg-[#121212] shadow-md border-t-4 border-[#FFD700]">
    ...
    <section class="py-12 px-6 bg-[#121212] shadow-md border-t-4 border-[#FFD700]">
       ...
       <section id="performances" class="py-12">
...
<!-- 📅 Calendar of Events Section -->
    ...
    <section id="contact" class="py-12 px-6 bg-[#8B0000] text-white border-t-4 border-[#FFD700] shadow-xl">
        <div class="max-w-4xl mx-auto text-center">
