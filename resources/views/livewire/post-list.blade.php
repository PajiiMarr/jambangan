                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex items-center space-x-2">
                                <flux:modal.trigger name="edit-post-{{ $post->post_id }}">
                                    <flux:button variant="ghost" wire:click="editPost({{ $post->post_id }})">
...
<!-- Edit Post Modal -->
<flux:modal name="edit-post-{{ $post->post_id }}" class="max-w-2xl">
    <div class="space-y-6">
        <div>
...
<!-- Delete Post Modal -->
<flux:modal name="delete-post-{{ $post->post_id }}" class="max-w-md">
    <div class="space-y-6">
        <div>
...
<!-- View Post Modal -->
<flux:modal name="view-post-{{ $post->post_id }}" class="max-w-4xl">
    <div class="space-y-6">
        <div>
...
<div x-data
    x-init="$wire.on('post-updated', () => {
        $dispatch('close-modal', 'edit-post-' + $wire.editingPost.post_id);
    })">
</div>
</div>
