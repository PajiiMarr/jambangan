...
<div class="w-full h-full mt-2">
        ...
        <div class="space-y-6">
            <div class="relative">
                ...
                <flux:dropdown class="absolute top-0 right-4 sm:right-1">
                    ...
                    <flux:menu>
                        <flux:menu.item icon="paper-airplane" data-publish-event x-show="window.selectedEventSppStatus === 'preview'">Publish</flux:menu.item>
                        <flux:menu.separator />
    ...
    >
        <div class="space-y-6">
            ...
            <div class="w-full h-48 bg-gray-200 rounded-lg overflow-hidden">
                <img id="edit_event_image" src="" alt="Event Cover" class="w-full h-full object-cover">
            </div>
            ...
            <x-inputs.filepond wire:model="editFileUpload" allowImagePreview allowFileTypeValidation acceptedFileTypes="image/*"/>
            <div class="flex">
                <flux:spacer />
    ...
    >
        <div class="space-y-6">
            ...
            <flux:input id="publish_event_name" label="Event Title" value="" disabled />
            <flux:input id="publish_event_id" type="hidden" />
            <div class="flex">
                <flux:spacer />
                <div class="flex justify-between w-full">
                    <flux:button wire:click="modal_close('publish-event')" class="w-1/2 mx-1" variant="filled">Cancel</flux:button>
                    <flux:button id="confirm-publish-event" class="w-1/2 mx-1" variant="primary">Confirm Publish</flux:button>
                </div>
            </div>
        </div>
    </flux:modal>
