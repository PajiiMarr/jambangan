...
<body class="bg-black">
    ...
    <section class="relative h-[60vh] flex items-center justify-center overflow-hidden"
        ...
        <div class="relative z-20 text-center px-4">
            ...
            <p class="text-xl sm:text-2xl text-gray-200">{{ $performance->type }}</p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    <div class="prose prose-invert max-w-none">
                        <h2 class="text-2xl font-bold text-white mb-6">About the Performance</h2>
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="space-y-6">
                        @forelse($performance->posts as $post)
                            <div class="group bg-[#121212] rounded-lg shadow-xl overflow-hidden transform transition-all duration-300 hover:scale-105">
                                ...
                                <div class="p-6">
                                    ...
                                    <a href="/posts/{{ $post->post_id }}" 
                                       class="mt-4 inline-flex items-center text-sm text-[#EAB308] hover:text-[#EF4444] transition-colors duration-300">
                                        Read More
                        ...
                        @empty
                            <p class="text-gray-400">No related posts yet.</p>
                        @endforelse
                    </div>
                </div>
            </div>
